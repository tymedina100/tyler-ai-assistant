...
TOOLS = [
    ...
    {"type": "function", "name": "get_crypto_price", "strict": False,
     "description": "Get the current price for a cryptocurrency. No API key required.",
     "parameters": {"type": "object", "properties": {"asset": {"type": "string"}, "vs_currency": {"type": "string"}}, "required": ["asset"]}},
...
DELEGATION_TOOLS = [
    ...
    {"type": "function", "name": "delegate_to_weather_agent", "strict": False,
     ...
     "parameters": {"type": "object", "properties": {"location": {"type": "string"}}, "required": ["location"]}},
    {"type": "function", "name": "delegate_to_crypto_agent", "strict": False,
     "description": "Delegate a current cryptocurrency price lookup or basic crypto market question to the Crypto Agent.",
