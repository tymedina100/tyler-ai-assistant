...
COPY main.py bot.py company_mode.py google_helpers.py github_helpers.py gumroad_helpers.py linear_helpers.py deploy_helpers.py railway_helpers.py projects.py ./
COPY projects.json ./
COPY files/ ./files/
